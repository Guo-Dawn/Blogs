import{ar as n,as as l,at as p}from"./index-D9NihZ4e.js";const t={class:"markdown-body"},i="测试文章-8",o="2026-01-17T00:00:00.000Z",j={address:"深圳",lng:114.05,lat:22.52},u=["typescript","javascript","programming"],d={__name:"typescript-guide",setup(c,{expose:a}){return a({frontmatter:{title:"测试文章-8",date:"2026-01-17T00:00:00.000Z",location:{address:"深圳",lng:114.05,lat:22.52},tags:["typescript","javascript","programming"]}}),(r,s)=>(l(),n("div",t,[...s[0]||(s[0]=[p(`<h1 id="typescript-从入门到精通" tabindex="-1"><a class="header-anchor" href="#typescript-从入门到精通">TypeScript 从入门到精通</a></h1><p>TypeScript 是 JavaScript 的超集，为 JavaScript 添加了静态类型检查。本文将带你从零开始掌握 TypeScript。</p><h2 id="为什么选择-typescript" tabindex="-1"><a class="header-anchor" href="#为什么选择-typescript">为什么选择 TypeScript？</a></h2><h3 id="类型安全" tabindex="-1"><a class="header-anchor" href="#类型安全">类型安全</a></h3><p>TypeScript 在编译时就能发现错误，而不是等到运行时：</p><pre class="hljs"><code><span class="hljs-comment">// JavaScript - 运行时才会发现错误</span>
