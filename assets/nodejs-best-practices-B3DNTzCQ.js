import{ar as n,as as l,at as p}from"./index-D9NihZ4e.js";const t={class:"markdown-body"},o="测试文章-7",i="2026-01-14T00:00:00.000Z",j={address:"广州",lng:113.26,lat:23.13},d=["nodejs","backend","best-practices"],u={__name:"nodejs-best-practices",setup(e,{expose:a}){return a({frontmatter:{title:"测试文章-7",date:"2026-01-14T00:00:00.000Z",location:{address:"广州",lng:113.26,lat:23.13},tags:["nodejs","backend","best-practices"]}}),(r,s)=>(l(),n("div",t,[...s[0]||(s[0]=[p(`<h1 id="nodejs-后端开发最佳实践" tabindex="-1"><a class="header-anchor" href="#nodejs-后端开发最佳实践">Node.js 后端开发最佳实践</a></h1><p>Node.js 是一个基于 Chrome V8 引擎的 JavaScript 运行时，让 JavaScript 能够在服务器端运行。本文将分享 Node.js 后端开发的最佳实践。</p><h2 id="项目结构" tabindex="-1"><a class="header-anchor" href="#项目结构">项目结构</a></h2><h3 id="推荐的目录结构" tabindex="-1"><a class="header-anchor" href="#推荐的目录结构">推荐的目录结构</a></h3><pre class="hljs"><code>project/
├── src/
│   ├── config/          # 配置文件
│   ├── controllers/     # 控制器
│   ├── services/        # 业务逻辑
