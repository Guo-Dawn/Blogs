...
</code></pre><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结">总结</a></h2><p>CSS Grid 是一个强大而灵活的布局系统，掌握它将让你的布局工作变得更加简单和高效。</p><blockquote><p>Grid 不是要取代 Flexbox，而是与之互补。根据实际需求选择合适的布局系统，或者组合使用它们。</p></blockquote>`,91)])]))}};export{d as date,m as default,o as location,u as tags,j as title};
